...
const pipelineResults = [
  ...
  { agent: 'ExecutionAgent', decision: 'PROCEED', result: '6/6 scenarios passed, 58 steps', duration: '12.5s' },
  { agent: 'ReportingAgent', decision: 'PROCEED', result: 'HTML/XML/JSON/Copado reports', duration: '0.6s' },
  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Scan the application for changes and run the full 9-agent end-to-end pipeline.
      </Typography>
      ...
      {completed && (
        <>
          <Alert severity="success" sx={{ mb: 2 }} icon={<CheckCircle />}>
            Pipeline completed — 6/6 scenarios passed, 58 steps executed in 17.9s
          </Alert>
          <Grid container spacing={2} sx={{ mb: 3 }}>
            <Grid item xs={6} sm={3}>
              <Card><CardContent sx={{ textAlign: 'center' }}>
                <Typography variant="h5" color="success.main" fontWeight={700}>6/6</Typography>
                <Typography variant="caption">Scenarios Passed</Typography>
              </CardContent></Card>
            </Grid>
            <Grid item xs={6} sm={3}>
              <Card><CardContent sx={{ textAlign: 'center' }}>
                <Typography variant="h5" color="primary" fontWeight={700}>58</Typography>
                <Typography variant="caption">Steps Executed</Typography>
              </CardContent></Card>
            </Grid>
            <Grid item xs={6} sm={3}>
              <Card><CardContent sx={{ textAlign: 'center' }}>
            ...
            <Grid item xs={6} sm={3}>
              <Card><CardContent sx={{ textAlign: 'center' }}>
                <Typography variant="h5" color="secondary" fontWeight={700}>17.9s</Typography>
