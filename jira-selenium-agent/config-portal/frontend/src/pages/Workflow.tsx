...
const steps = [
  ...
  { agent: 'APITestingAgent', desc: 'Execute REST API tests: health check, CRUD operations, validation, dropdown metadata, sub-categories', inputs: 'App URL, Test data JSON', outputs: 'API test results (10 scenarios, 30 steps)', ai: false },
