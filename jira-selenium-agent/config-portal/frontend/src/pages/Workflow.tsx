...
const steps = [
  ...
  { agent: 'ExecutionAgent', desc: 'Run Selenium UI tests via POM page objects against target application', inputs: 'POM, Data bundles, App URL', outputs: 'UI test results (pass/fail per scenario)', ai: false },
  { agent: 'APITestingAgent', desc: 'Execute REST API tests: CRUD operations, validation, dropdown metadata + multi-relationship tests (Lookup/Master-Detail traversal, cross-object SOQL, data isolation, custom object __c/__r)', inputs: 'App URL, Test data JSON, Relationship schema', outputs: 'API test results (18 scenarios: 10 CRUD + 8 relationships)', ai: false },
...
export default function Workflow() {
  return (
    <Box>
      <Typography variant="h5" fontWeight={600} gutterBottom>Workflow — 10-Agent Pipeline</Typography>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Visual execution flow showing each autonomous agent (UI + API testing), its inputs/outputs, and decision logic.
      </Typography>
